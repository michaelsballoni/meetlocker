...
## Storage
The user provides the password and the file, and the server puts the file into a ZIP file protected by the password.  The server generates a key and uses this key and the password to determine where to store the ZIP file.  The key is returned to the user.  
